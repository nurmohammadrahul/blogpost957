...
const Content = () => {
    ...
    return (
        <div
            className="mx-auto p-2 group border-2 border-opacity-30 focus:no-underline dark:bg-gray-50 hidden sm:block">
            ...
            <div className="space-y-2">
                <a href={url} target='blank' className="text-2xl font-semibold group-hover:underline group-focus:underline">{title}</a>
