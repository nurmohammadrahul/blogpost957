...
const Blog = () => {
    ...
    const { tags,comments_count, title, reading_time_minutes, public_reactions_count, published_at } = blog
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex flex-col items-start justify-between w-full md:flex-row md:items-center dark:text-gray-600">
                        <div className="flex items-center md:space-x-2">
                            <img src="" alt="" className="w-4 h-4 border rounded-full dark:bg-gray-500 dark:border-gray-300" />
                    ...
                    <div className="flex items-center -mx-4 overflow-x-auto overflow-y-hidden sm:justify-start flex-nowrap dark:bg-gray-100 dark:text-gray-800">
                        ...
                        {/*bookmark button*/}
                        <div onClick={()=>handleBookmark(blog)} className='bg-primary p-2 ml-5 rounded-full hover:bg-opacity-30 hover:scale-105 overflow-hidden hover:cursor-pointer'>
